...
- 🔍 **多源发现策略** — B 站四策略（搜索 · 关联链 · 趋势 · 跨域探索，搜索冷却时后端具备扩展任务桥兜底）+ 小红书三层安全发现 + 抖音插件签名 search / hot / feed + X 搜索 / For-You / 关注作者，跨平台协同工作
...
| 来源 | 发现方式 | 说明 |
|------|----------|------|
| **B 站** | Search · Trending · Related Chain · Explore · 扩展搜索任务桥 | 四大策略均衡协作，API 直连为主；服务端 search 冷却且扩展在线时，后端可入队浏览器搜索任务并接收回传结果 |

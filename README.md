...
最新版本：**v0.3.103 / extension v0.3.70: X（Twitter）内容源接入（2026-06-09）**。完整变更详见 [docs/changelog.md](docs/changelog.md)。
...
最新版本：**v0.3.103 / extension v0.3.70: X（Twitter）内容源接入（2026-06-09）**。最近更新见上方摘要；完整历史见 [docs/changelog.md](docs/changelog.md)。插件包见 [GitHub Releases](https://github.com/whiteguo233/OpenBiliClaw/releases)，后端源码更新看 `backend-v*` tag，不发布后端桌面包。
